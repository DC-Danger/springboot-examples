package com.hz.learnboot.aop.aspects;

import com.hz.learnboot.aop.annotation.BusinessLogAnnotation;
...
public class BusinessLogAspect {
    ...
    @Pointcut(value = "@annotation(com.hz.learnboot.aop.annotation.BusinessLogAnnotation)")
